...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        int[][] degatsAttaques = {
            {25, 50}, // Pikachu
            {10, 20, 35, 80}, // Charmander
            {15, 25} // Bulbizarre
        };

        int[][] coutAttaques = {
            {15, 25}, // Pikachu
            {0, 10, 20, 40}, // Charmander
            {5, 15} // Bulbizarre
        };
        ...
        String[] nomsPokemon = {"PIKACHU", "DRACAUFEU", "BULBIZARRE"};
        String[][] nomsAttaques = {
            {"Éclair", "Fatal-Foudre"},
            {"Griffe", "Flammèche", "Draco Souffle", "Feu d'Enfer"},
            {"Fouet Lianes", "Tranch'Herbe"}
        };
        ...
        do {
            System.out.println();
            System.out.println();
            System.out.println("Veuillez choisir entre les options suivantes (1 ou 2): ");
            System.out.println();
            System.out.println();
            System.out.println("1 - Jouer avec 1 Pokemon");
            System.out.println("2 - Jouer avec 3 Pokémons");
            System.out.print("\t\n\n Reponse: ");
        ...
        if (optionMenu == 1) {
            ...
            do {
                ...
                do {
                    ...
                    if(pvPokemonJoueur > 0 && pvPokemonAdverse <= 0){
            ...
            // attaquesDesPokemons.add(charmanderAttaques);
            // attaquesDesPokemons.add(bulbizarreAttaques);
            // attaquesDesPokemons.add(pikachuAttaques);
            System.out.println();
            System.out.println();
            ...
            do {
                System.out.print("Veuillez choisir un Pokémon (1, 2 ou 3): ");
                while (!scanner.hasNextInt()) {
                    System.out.print("Saisie invalide. Veuillez choisir une valeur de type entier (1, 2 ou 3): ");
                    scanner.next();
                }
                choixPokemon = scanner.nextInt();
            } while (choixPokemon < 1 || choixPokemon > 3);

            switch (choixPokemon) {
                case 1:
                    nomPokemon = nomsPokemon[0];
                    break;
                case 2:
                    nomPokemon = nomsPokemon[1];
                    break;
                case 3:
                    nomPokemon = nomsPokemon[2];
                    break;
                default:
                    break;
            }
            ...
            do {
                ...
                do {
                    ...
                    do {
                        ...
                        String[] attaquesChoisies = nomsAttaques[choixPokemon - 1];
                        int[] degatsChoisis = degatsAttaques[choixPokemon - 1];
                        int[] coutChoisis = coutAttaques[choixPokemon - 1];
                        ...
                        if (choixMenuJoueur==1) {
                            ...
                            String separator3 = "+-------------------------------------------------------------------------------------+";
                            System.out.println(separator3);
                            System.out.printf("| %-83s |\n", "                                 LISTE DES ATTAQUES DE ", nomPokemon);
                            System.out.printf("| %-25s  %-25s  %-16s  %-11s |\n", "Numéro de l'attaque", "Nom de l'attaque", "Dégâts", "Coût(PP)");
                            System.out.println(separator3);
                            for (int i = 0; i < attaquesChoisies.length; i++) {
                                System.out.printf("| %-28s %-25s  %-20d  %-4d  |\n", (i + 1), attaquesChoisies[i], degatsChoisis[i], coutChoisis[i]);
                                System.out.println(separator3);
                            }

                            do {
                                System.out.print("Veuillez choisir le numero d'attaque(1 - "+attaquesChoisies.length+"): ");
                                while (!scanner.hasNextInt()) {
                                    System.out.print("Saisie invalide.Veuillez choisir le numero d'attaque(1 - "+attaquesChoisies.length+"): ");
                                    scanner.next();
                                }
                                choixAttaqueJoueur =  scanner.nextInt();
                            } while (choixAttaqueJoueur < 1 || choixAttaqueJoueur > attaquesChoisies.length);
                            System.out.println();

                            degatAttaqueChoisit = degatsChoisis[choixAttaqueJoueur - 1];
                            coutChoixAttaque = coutChoisis[choixAttaqueJoueur - 1];
                            nomAttaque = attaquesChoisies[choixAttaqueJoueur - 1];
